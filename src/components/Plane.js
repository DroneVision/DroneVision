...
const renderCenterButton = (
  ...
  switch (type) {
    case 'Current':
      return (
        <Button
          disabled={allDisabled || latestCommandMessage === 'Hold'}
    ...
    case 'Up':
      return (
        <Button
          disabled={allDisabled || latestCommandMessage === 'Up'}
          onClick={() =>
            addDirection(
    ...
    case 'Down':
      return (
        <Button
          disabled={allDisabled || latestCommandMessage === 'Down'}
          onClick={() =>
            addDirection(
...
const Plane = props => {
  ...
  console.log('lcm', latestCommandMessage);
          ...
          <td>
            <Button
              disabled={
                ...
                forwardDisabled ||
                allDisabled ||
                latestCommandMessage === `${prefix}Forward + Left`
              }
              onClick={() =>
                addDirection(
          ...
          <td>
            <Button
              disabled={
                forwardDisabled ||
                allDisabled ||
                latestCommandMessage === `${prefix}Forward`
              }
              onClick={() =>
                addDirection(
          ...
          <td>
            <Button
              disabled={
                ...
                forwardDisabled ||
                allDisabled ||
                latestCommandMessage === `${prefix}Forward + Right`
              }
              onClick={() =>
                addDirection(
          ...
          <td>
            <Button
              disabled={
                leftDisabled ||
                allDisabled ||
                latestCommandMessage === `${prefix}Left`
              }
              onClick={() =>
                addDirection(
          ...
          <td>
            <Button
              disabled={
                rightDisabled ||
                allDisabled ||
                latestCommandMessage === `${prefix}Right`
              }
              onClick={() =>
                addDirection(
          ...
          <td>
            <Button
              disabled={
                ...
                reverseDisabled ||
                allDisabled ||
                latestCommandMessage === `${prefix}Reverse + Left`
              }
              onClick={() =>
                addDirection(
          ...
          <td>
            <Button
              disabled={
                reverseDisabled ||
                allDisabled ||
                latestCommandMessage === `${prefix}Reverse`
              }
              onClick={() =>
                addDirection(
          ...
          <td>
            <Button
              disabled={
                ...
                reverseDisabled ||
                allDisabled ||
                latestCommandMessage === `${prefix}Reverse + Right`
              }
              onClick={() =>
                addDirection(
