...
let macDisconnect = require('./mac-disconnect.js');
let macEnableAirport = require('./mac-enable-airport.js');
...
function init(options) {
    ...
    switch (process.platform) {
        ...
        case "darwin":
            ...
            scan = macScan(config);
            enableAirport = macEnableAirport(config);
    ...
    exports.enableAirport = enableAirport;
...
exports.enableAirport = function () {
    throw new Error("ERROR : use init before");
};
